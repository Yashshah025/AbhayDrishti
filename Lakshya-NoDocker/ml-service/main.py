...
Endpoints:
  ...
  POST /forecast  -> heuristic next-15-minute pressure forecast
...
from ml.forecaster import PhysicsForecaster
...
class ForecastWindow(BaseModel):
    """30-minute window of features for LSTM."""
...
def forecast(req: ForecastRequest):
    series = forecaster.predict(req.window.dict(), horizon=req.horizon_minutes)
    return {
        "site_id": req.site_id,
        "horizon_minutes": req.horizon_minutes,
        "forecast": series,
        "model": "physics-heuristic",
    }
