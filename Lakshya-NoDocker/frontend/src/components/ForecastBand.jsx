...
/** Mini sparkline showing the LSTM 15-minute pressure forecast band. */
  ...
  if (!data.length) {
    return (
      <p className="mt-3 text-[10px] text-slate-500 font-mono">
        Forecast unavailable — awaiting LSTM output…
      </p>
    )
  }
  ...
  return (
    <div className="mt-3 flex items-center gap-3">
      ...
      <div className="text-right">
        <p className="text-[10px] text-slate-500 uppercase">Peak T+5</p>
