...
export default function SiteDashboard() {
  ...
  // Live snapshot from socket overrides REST status
  const liveStatus = snapshot ? buildStatusFromSnapshot(snapshot, site) : status
  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-3 flex-1">
        ...
        {/* Right column */}
        <div className="space-y-3">
          <SimulationControls status={liveStatus} onAction={() => { fetchStatus(); fetchAlerts() }} site={site.id} />
          <div className="glass p-5 rounded-2xl">
